...
def main(
    ...
    rspan_1 = [100e-9, 30e-6]  # max and min range of radii to sample [m]
    ...
    #
    # # attribute generators
    # xiprobdist_2 = attrgens_zerodbox_fp.SampleXiFP2024()
    # radiigen_2 = attrgens_zerodbox_fp.SampleRadiiFP2024(
    #     volexpr0_2, rspan_2
    # )  # radii are sampled from rspan [m]

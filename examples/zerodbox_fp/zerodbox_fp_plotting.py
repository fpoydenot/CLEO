...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default="/home/m/m301163/CLEO",
    )
    parser.add_argument(
        "--savefigpath",
        type=Path,
        help="Absolute path to build",
        default="/home/m/m301163/CLEO/build_colls0d_fp/zerodbox_fp/bin",
    )
    parser.add_argument(
        "--grid_filename",
        type=Path,
        help="Absolute path to gridbox boundaries file",
        default="/home/m/m301163/CLEO/build_colls0d_fp/zerodbox_fp/share/zerodbox_fp_dimlessGBxboundaries.dat",
    )
    parser.add_argument(
        "--setupfile",
        type=Path,
        help="Absolute path to setup file",
        default="/home/m/m301163/CLEO/build_colls0d_fp/zerodbox_fp/bin/zerodbox_fp_diffgrav_setup.txt",
    )
    parser.add_argument(
        "--dataset",
        type=Path,
        help="Absolute path to dataset",
        default="/home/m/m301163/CLEO/build_colls0d_fp/zerodbox_fp/bin/zerodbox_fp_diffgrav_sol.zarr/",
    )
    parser.add_argument(
        "--kernel",
        type=str,
...
def plot_zerodbox_fp_plot_validation_figure(
    path2CLEO,
    grid_filename,
    setupfile,
    dataset,
...
def main(path2CLEO, savefigpath, grid_filename, setupfile, dataset, kernel):
    ...
    plot_zerodbox_fp_plot_validation_figure(
        path2CLEO,
        grid_filename,
        setupfile,
        dataset,
